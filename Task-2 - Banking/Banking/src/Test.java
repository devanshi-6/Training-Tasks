...
public class Test {
    public static void main(String[] args) {
        BankAccount bankAccount = BankAccount.getInstance("Person1", 100000);

        Scanner scanner = new Scanner(System.in);
        String answer = null;
        while (true){
            System.out.println("Welcome " +  bankAccount.owner + " to The Bank!");
            ...
            if(a == 1){
                System.out.println("Your balance is Rs" + bankAccount.balance );
